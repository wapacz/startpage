...
export default function PrimarySearchAppBar({ window }) {
    ...
    const drawer = (
        <Box onClick={() => setMobileDrawerOpen(!mobileDrawerOpen)} sx={{ textAlign: 'center' }}>
    ...
    const renderMobileMenu = (
        <Menu anchorEl={mobileMoreOpen} anchorOrigin={{ vertical: 'top', horizontal: 'right', }} id={MOBILE_MENU_ID} keepMounted transformOrigin={{ vertical: 'top', horizontal: 'right', }} open={isMobileMenuOpen} onClose={() => setMobileMoreOpen(null)}>
                ...
                <AppBar position="nav">
                    <Toolbar>
                        ...
                        <Box sx={{ display: { xs: 'flex', md: 'none' } }}>
                            <IconButton size="large" aria-label="show more" aria-controls={MOBILE_MENU_ID} aria-haspopup="true" onClick={(event) => setMobileMoreOpen(event.currentTarget)} color="inherit">
                                <MoreIcon />
                            </IconButton>
                        </Box>
                    </Toolbar>
